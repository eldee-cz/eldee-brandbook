...
//   wordmark-mono-dark.svg          — celý wordmark tmavě, pro jednobarevný tisk na světlé.
//   wordmark-vertical-mono-dark.svg — totéž pro svislou kompozici.
//                            Doplněno 22. 9. 2026: mono sada měla jen světlou půlku, takže
//                            na světlý podklad nebylo co dát a hrozilo ruční odbarvení masteru.
//
...
for (const jmeno of ['monogram-ld', 'monogram-mono', 'wordmark-mono', 'wordmark-vertical-mono']) {
  ...
  const tmavy = master
    ...
    .replace('<!-- eldee', '<!-- TMAVÁ VARIANTA (odvozeno skriptem generate-monogram-dark.mjs) · eldee');
